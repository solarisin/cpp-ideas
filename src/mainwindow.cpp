...
CppIdeasMainWindow::CppIdeasMainWindow(QWidget* parent) : QMainWindow(parent) {
    LOG_F(INFO, "Starting CppIdeasMainWindow constructor...");
    ...
    LOG_F(INFO, "CppIdeasMainWindow constructor completed");
}
void CppIdeasMainWindow::processJson() {
...
void CppIdeasMainWindow::clearAll() {
    inputText->clear();
    resultText->clear();
...
void CppIdeasMainWindow::generateSampleJson() {
...
void CppIdeasMainWindow::loadJsonFile() {
...
void CppIdeasMainWindow::saveJsonFile() {
...
void CppIdeasMainWindow::setupUI() {
...
void CppIdeasMainWindow::setupMainTab(QWidget* parent) {
    ...
    connect(generateBtn, &QPushButton::clicked, this, &CppIdeasMainWindow::generateSampleJson);
    controlsLayout->addWidget(generateBtn);
    
    controlsLayout->addStretch();
    
    auto* loadBtn = new QPushButton("Load JSON File");
    connect(loadBtn, &QPushButton::clicked, this, &CppIdeasMainWindow::loadJsonFile);
    controlsLayout->addWidget(loadBtn);
    
    auto* clearBtn = new QPushButton("Clear All");
    connect(clearBtn, &QPushButton::clicked, this, &CppIdeasMainWindow::clearAll);
    ...
    connect(processBtn, &QPushButton::clicked, this, &CppIdeasMainWindow::processJson);
    ...
    saveBtn->setStyleSheet("QPushButton { background-color: #4CAF50; color: white; font-weight: bold; padding: 8px; }");
    connect(saveBtn, &QPushButton::clicked, this, &CppIdeasMainWindow::saveJsonFile);
...
void CppIdeasMainWindow::setupHelpTab(QWidget* parent) {
    auto* layout = new QVBoxLayout(parent);
...
void CppIdeasMainWindow::setupMenuBar() {
    auto* fileMenu = menuBar()->addMenu("File");
    
    auto* loadAction = fileMenu->addAction("Load JSON File");
    connect(loadAction, &QAction::triggered, this, &CppIdeasMainWindow::loadJsonFile);
    
    auto* saveAction = fileMenu->addAction("Save Result");
    connect(saveAction, &QAction::triggered, this, &CppIdeasMainWindow::saveJsonFile);
...
void CppIdeasMainWindow::setupStatusBar() {
